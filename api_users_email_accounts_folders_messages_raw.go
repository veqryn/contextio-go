...
func (cioLite *CioLite) GetUserEmailAccountsFolderMessageRaw(userID string, label string, folder string,
	messageID string, queryValues CioParams) (GetUserEmailAccountsFolderMessageRawResponse, error) {
