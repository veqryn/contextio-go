...
func (cioLite *CioLite) MarkUserEmailAccountsFolderMessageRead(userID string, label string, folder string,
	messageID string, formValues CioParams) (UserEmailAccountsFolderMessageReadResponse, error) {
...
func (cioLite *CioLite) MarkUserEmailAccountsFolderMessageUnRead(userID string, label string, folder string,
	messageID string, formValues CioParams) (UserEmailAccountsFolderMessageReadResponse, error) {
